...
var fahenhiet:number= 200;
var celcius:number=100;

 var celsius:number = (fahenhiet - 32) * 5/9;
console.log(fahenhiet);

var f:number = (celcius * (9 / 5)) + 32;
console.log(celcius);

// write a program that calculate the percentage

var totalmarks:number =1100;
var otainedmarks:number=750;
var percentage:number=100 *otainedmarks/ totalmarks;
...
if ( productprice>100){console.log("10%discount")}
else{console.log ("5%")}
 
// 

var age_ayesha : number = 22;
...
// 
var temperture:string ="hot weather"
if (temperture=="hot weather"){
    console.log("temperture")
}
else{console.log("warm clothes")}
...
else{console.log("number is not divisble")}
...
var price:number=20;
if(unit>=100){
    var calculate:number=unit* price + (10/100);
    console.log("calculate value,",calculate)
}
else if(unit>=200){
    var calculate:number=unit* price + (15/100);
    console.log("calculate value,",calculate)
}
else if(unit>=500){
    var calculate:number=unit* price + (25/100);
    console.log("calculate value,",calculate)
}
